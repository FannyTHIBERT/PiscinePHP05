...
$naruto = new Animal("Naruto", 4, Animal::FISH);

echo $naruto->getName() . " has " . $naruto->getLegs() . " legs and is a " .

$naruto->getType() . ".\n";



$sasuke = new Animal("Sasuke", 4, Animal::BIRD);

echo $sasuke->getName() . " has " . $sasuke->getLegs() . " legs and is a " .

$sasuke->getType() . ".\n";



var_dump(Animal::getNumberOfAnimalsAlive());

var_dump(Animal::getNumberOfMammals());

var_dump(Animal::getNumberOfFishes());

var_dump(Animal::getNumberOfBirds());*/
